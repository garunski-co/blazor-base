...
public static class LinqExtensions
{
    ...
    /// </summary>
    public static IQueryable<T> WhereIf<T>(this IQueryable<T> query, bool predicate,
        Expression<Func<T, bool>> itemPredicate)
    {
        return predicate ? query.Where(itemPredicate) : query;
    }

    public static IQueryable<T> OrderByIf<T>(this IQueryable<T> query, bool predicate,
        Expression<Func<T, object>> keySelector)
    {
        return predicate ? query.OrderBy(keySelector) : query;
    }

    public static IQueryable<T> OrderByDescendingIf<T>(this IQueryable<T> query, bool predicate,
        Expression<Func<T, object>> keySelector)
    {
    ...
    public static IEnumerable<T> OrderByDescendingIf<T>(this IEnumerable<T> source, bool predicate,
